...
function saveAllStates(filename::AbstractString, key::AbstractString,
        AllStates::AbstractVector{<:SBitVector})
...
function saveHamiltonian(filename::AbstractString, key::AbstractString, H::Symmetric)
    saveHamiltonian(filename, key, H.data)
end
