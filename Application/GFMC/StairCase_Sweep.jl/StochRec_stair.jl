...
julia -O3 -t $SLURM_CPUS_PER_TASK --heap-size-hint=210G /pc2/groups/hpc-prf-pm2frg/niggeni/Jobs/SpiderWebModel.jl/Application/GFMC/StairCase_Sweep.jl/StochRec_stair.jl $SLURM_ARRAY_TASK_ID
exit
=#
...
i_arg = isinteractive() ? 8 : parse(Int, ARGS[1])
