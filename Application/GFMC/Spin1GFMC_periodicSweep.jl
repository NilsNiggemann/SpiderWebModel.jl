...
julia -O3 -t $SLURM_CPUS_PER_TASK $PROJECT_pmfrg/niggemann1/Jobs/SpiderWebModel.jl/Application/GFMC/Spin1GFMC.jl ${SLURM_ARRAY_TASK_ID}
exit
=#
...
L = [16,18,20,22,24][(i_arg-1) %5+1]
i_arg = div(i_arg,5)
nBra = 8
NSteps = 120_000
equilibration_steps = 80_000
NWalkers = 48*100
