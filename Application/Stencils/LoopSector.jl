...
##
# folder = "temp/LoopSectorNoInit/L=$(size(S,1))/four_strings"
...
res_string_condensate_20 = getMuSweep("temp/LoopSectorNoInit/L=20/string_condensate",100)
...
res1 = getRes("temp/LoopSectorNoInit/L=20/string_condensate/μ=$μ")
